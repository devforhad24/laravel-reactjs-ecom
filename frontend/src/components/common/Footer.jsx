      ...
      <div className="container">
        <div className="row mb-2">
          <div className="col-md-3 pb-5">
            ...
            <div className="pt-3 pe-5 text-justify">
              Businesses use eCommerce websites to reach more customers, manage
              orders, and operate 24/7 without a physical store.
            </div>
          </div>
          ...
          <div className="col-md-3">
            ...
            <ul>
              <li>
                <a href="">+880-1794430234</a>
              </li>
              <li>
                <a href="">fkbazar34@gmail.com</a>
              </li>
              <Container className="d-flex gap-3 fs-4">
                <Link
                  to="https://www.facebook.com/fkbazar24/"
                  target="_blank"
                ...
                {/* <Link to="https://www.facebook.com/fkbazar24/" className=" social-icon"><i className="bi bi-facebook"></i></Link> */}
                <Link
                  to="https://wa.me/+8801794430234"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-icon"
                >
        ...
        <div className="row">
          <div className="col-md-12 text-center pt-5">
            <p>
              &copy; 2025 All Right Reserved || Developed by -{" "}
              <span>
                <i>Hossain Forhad</i>
              </span>
            </p>
