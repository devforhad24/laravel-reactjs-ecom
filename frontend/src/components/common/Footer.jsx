            ...
            <div className="container">
                <div className="row mb-5">
                    <div className="col-md-3 pb-5">
                        ...
                        <div className='pt-3 pe-5'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Unde, nostrum</div>
                    </div>
                    ...
                    <div className="col-md-3">
                        ...
                        <ul>
                            <li>
                                <a href="">+91-258xxxxxx</a>
                            </li>
                            <li>
                                <a href="">info@testemail.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12 text-center pt-5">
                        <p>&copy; 2025 All Right Reserved || Developed by - <span><i>Hossain Forhad</i></span></p>
                    </div>
                </div>
            </div>
        </footer>
